...
\begin{document}
    ...
    a given list of points we can find its optimal path. Both scenarios can be seen 
    in the figure below.  figure below shows both an entangled suboptimal path and 
    a detangled optimal path. 
